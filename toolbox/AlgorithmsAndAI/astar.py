...
Al and Algorithsms, learnging about A star search algorithm

Advantages of A star over bread-first search: 

Advantages of A start over depth-first and breadth-first search search: very in-efficient
    is a "blind"search that involves guessing nodes and computes many possibilities
"""
